...
public class Game {
    ...
    public Game(final Board board, final Player player1, final Player player2, final PrintStream output) {
        this.board = board;
    ...
    private Move getMoveFromPlayer(Player player) { // :NOTE: а что если игрок по сети (DONE)
        ...
        output.println(board);
        return player.makeMove(board.getPosition(), board.getTurn()); // :NOTE: а что если игрок по сети
    }
